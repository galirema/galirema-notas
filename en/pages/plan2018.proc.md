...
* Especies de algas añadidas en el plan de 2018
	* _Enteromorpha crinita_ (FAO)=? / (WoRMS) -C- _Ulva clathrata_ (Roth) C.Agardh, 1811 (FAO)=? / -S- _Enteromorpha clathrata_ (Roth) Greville, 1830 (FAO)=__EOW__
	* _Gracilaria multipartita_ (FAO)=? / __G1M__ Los sinónimos No aparecen en la FAO (_Fucus multipartitus_ Clemente 1807; _Chondrus multipartitus_ (Clemente) Greville 1833)
	* _Codium fragile_ (FAO)=__KII__
