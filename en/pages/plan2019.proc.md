...
* __BESP__: Pepapación de los datos, Cargar los campos del cuadro en `pexma2018` los planes de zonas de libre marisqueo, y los campos `tipoCode` __BESP__, `conxunto` __(F/T)__, y el campo `id_plan_explotacion`  Núm. Registros: __50__
* __DPER__: Pepapación de los datos,
* __FEQD__: Pepapación de los datos,
* __GSOL__: Pepapación de los datos,
* __HPEN__: Pepapación de los datos,
* __IALG__: Pepapación de los datos,
* __JANE__: Pepapación de los datos,
* __KPOL__: Pepapación de los datos,
