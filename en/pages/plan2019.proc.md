...
* __AAUT__: Pepapación de los campos, Cargar los campos del cuadro en `pexma2018` los planes de Autorizaciones, y los campos `tipoCode` __AAUT__, `conxunto` __(F/T)__, y el campo `id_plan_explotacion`  Núm. Registros: __47__
* __BESP__: Pepapación de los campos, 
